...
class ConstantParityTests(unittest.TestCase):
    ...
    def test_model_extension_image_override(self):
        """D26（2026-09-26）：延伸背景模式的生圖端覆蓋，兩邊必須逐字相同。"""
        self.assert_same(
            "MODEL_EXTENSION_IMAGE_OVERRIDE", news_prompt.MODEL_EXTENSION_IMAGE_OVERRIDE
        )
