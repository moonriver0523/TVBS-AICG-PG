...
class SpecGeometryTests(unittest.TestCase):
    ...
    def test_editor_frame_is_the_whole_alignment_guide(self):
        """編輯框＝對位框紅線內緣本身，不再內縮成 16:9。

        2026-08-14 曾內縮到 142/70/1643/924 以求 FIT 零裁切，代價是左右各 52px
        由 backdrop 漸層補——編輯 2026-08-17 回報那兩條色帶裁完還在、後製難處理。
        改回整個紅框後由 safe_frame 水平拉伸填滿。
        """
