...
#
# 2026-09-16 調高到 12000（B29／F39）：4000 這個值把**後半段**也一起切掉了，而後半段
...
# 的 prompt 一律被截。
# 12000 的來由：規則前綴實測約 1900–3000 字，`structure` 最大 2097、`variable` 最大 336，
# 加上尾段與成長餘裕約 6500，取三倍現行值仍是有界的。新聞原文本來就完整留（≤5000），
# 多這幾 KB 不改變這個檔的量級。
